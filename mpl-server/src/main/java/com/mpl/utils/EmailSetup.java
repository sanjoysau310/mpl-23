...
public class EmailSetup {
	...
	public static String getEmailBodyForRegistration(HttpServletRequest request, Player player, Login loginBean) {
		...
		// Get client's origin
				...
				String paymentStatus=player.getpPaymentMode().equals("Cash")?"Pending": player.getpPaymentSatus();

				String tableText = "<table align='center'><thead><tr><th colspan='2'><h3>MPL 2023 Player Registration</h3></th></tr></thead>"
						+ "<tbody><tr><td>Full Name</td><td>"+ player.getpName() + "</td></tr>"
						+ "<tr><td>Phone</td><td>" + player.getpPhone() + "</td></tr>"
						+ "<tr><td>Email</td><td>" + player.getpEmail() + "</td></tr>"
						+ "<tr><td>Date of Birth</td><td>"+ player.getpDob() + "</td></tr>"
						+ "<tr><td>Role</td><td>" + player.getpRole() + "</td></tr>"
						+ "<tr><td>Batting Style</td><td>" + player.getpBatting() + "</td></tr>"
						+ "<tr><td>Bowling Style</td><td>" + player.getpBowling() + "</td></tr>"
						+ "<tr><td>Kit Size</td><td>"+ player.getpKit() + "</td></tr>"
						+ "<tr><td>Registration Fees</td><td>" + player.getpFees()+ "</td></tr>"
						+ "<tr><td>Payment Mode</td><td>" + player.getpPaymentMode() + "</td></tr>"
						+ "<tr><td>Payment Status</td><td>"+paymentStatus+"</td></tr>" + "</tbody></table>";
				
				String loginDetails="<br><br>"
