...
public class Player {
	...
	public String getpPaymentSatus() {
	...
	public String toString() {
		return "PlayerBean [pId=" + pId + ", pName=" + pName + ", pEmail=" + pEmail + ", pPhone=" + pPhone
				...
				+ pStatus + ", pPaymentMode=" + pPaymentMode + ", pPaymentStatus=" + pPaymentStatus + "]";
	}
}
